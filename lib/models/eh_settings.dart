...
class EhSettings {
  ...
  factory EhSettings.fromJson(Map<String, dynamic> json) => EhSettings(
      profilelist: (json['profilelist'] as List? ?? [])
          ...
          .toList(),
      profileSelected: json['profile_selected'] != null
          ? json['profile_selected'] as String
          : null,
      defaultProfile: json['default_profile'] != null
          ? json['default_profile'] as String
          : null,
      loadImageThroughHAtH: json['load_image_through_hAtH'] != null
          ? json['load_image_through_hAtH'] as String
          : null,
      loadBrowsingCountry: json['load_browsing_country'] != null
          ? json['load_browsing_country'] as String
          : null,
      imageSize:
          json['image_size'] != null ? json['image_size'] as String : null,
      imageSizeHorizontal: json['image_size_horizontal'] != null
          ? json['image_size_horizontal'] as String
          : null,
      imageSizeVertical: json['image_size_vertical'] != null
          ? json['image_size_vertical'] as String
          : null,
      galleryNameDisplay: json['gallery_name_display'] != null
          ? json['gallery_name_display'] as String
          : null,
      archiverSettings: json['archiver_settings'] != null
          ? json['archiver_settings'] as String
          : null,
      frontPageSettings: json['front_page_settings'] != null
          ? json['front_page_settings'] as String
          : null,
      ctDoujinshi:
          json['ct_doujinshi'] != null ? json['ct_doujinshi'] as String : null,
      ctManga: json['ct_manga'] != null ? json['ct_manga'] as String : null,
      ctArtistcg:
          json['ct_artistcg'] != null ? json['ct_artistcg'] as String : null,
      ctGamecg: json['ct_gamecg'] != null ? json['ct_gamecg'] as String : null,
      ctWestern:
          json['ct_western'] != null ? json['ct_western'] as String : null,
      ctNonH: json['ct_non-h'] != null ? json['ct_non-h'] as String : null,
      ctImageset:
          json['ct_imageset'] != null ? json['ct_imageset'] as String : null,
      ctCosplay:
          json['ct_cosplay'] != null ? json['ct_cosplay'] as String : null,
      ctAsianporn:
          json['ct_asianporn'] != null ? json['ct_asianporn'] as String : null,
      ctMisc: json['ct_misc'] != null ? json['ct_misc'] as String : null,
      favorites: (json['favorites'] as List? ?? [])
          .map((e) => EhSettingItem.fromJson(e as Map<String, dynamic>))
          .toList(),
      sortOrderFavorites: json['sort_order_favorites'] != null
          ? json['sort_order_favorites'] as String
          : null,
      ...
      xl: (json['xl'] as List? ?? [])
          .map((e) => EhSettingItem.fromJson(e as Map<String, dynamic>))
          .toList(),
      tagFilteringThreshold: json['tag_filtering_threshold'] != null
          ? json['tag_filtering_threshold'] as String
          : null,
      tagWatchingThreshold: json['tag_watching_threshold'] != null
          ? json['tag_watching_threshold'] as String
          : null,
      excludedUploaders: json['excluded_uploaders'] != null
          ? json['excluded_uploaders'] as String
          : null,
      xuQuotaUsing:
          json['xu_quota_using'] != null ? json['xu_quota_using'] as int : null,
      xuQuotaMax:
          json['xu_quota_max'] != null ? json['xu_quota_max'] as int : null,
      searchResultCount: json['search_result_count'] != null
          ? json['search_result_count'] as String
          : null,
      mouseOverThumbnails: json['mouse-over_thumbnails'] != null
          ? json['mouse-over_thumbnails'] as String
          : null,
      thumbnailSize: json['thumbnail_size'] != null
          ? json['thumbnail_size'] as String
          : null,
      thumbnailRows: json['thumbnail_rows'] != null
          ? json['thumbnail_rows'] as String
          : null,
      thumbnailScaling: json['thumbnail_Scaling'] != null
          ? json['thumbnail_Scaling'] as String
          : null,
      viewportOverride: json['viewport_override'] != null
          ? json['viewport_override'] as String
          : null,
      sortOrderComments: json['sort_order_comments'] != null
          ? json['sort_order_comments'] as String
          : null,
      showCommentVotes: json['show_comment_votes'] != null
          ? json['show_comment_votes'] as String
          : null,
  ...
  EhSettings copyWith(
      ...
      EhSettings(
        ...
        tagFilteringThreshold:
            tagFilteringThreshold ?? this.tagFilteringThreshold,
        ...
        showGalleryPageNumbers:
            showGalleryPageNumbers ?? this.showGalleryPageNumbers,
        hentaiAtHomeLocalNetworkHost:
            hentaiAtHomeLocalNetworkHost ?? this.hentaiAtHomeLocalNetworkHost,
  ...
  bool operator ==(Object other) =>
      ...
      other is EhSettings &&
          ...
          loadBrowsingCountry == other.loadBrowsingCountry &&
          imageSize == other.imageSize &&
          imageSizeHorizontal == other.imageSizeHorizontal &&
          imageSizeVertical == other.imageSizeVertical &&
          galleryNameDisplay == other.galleryNameDisplay &&
          archiverSettings == other.archiverSettings &&
          frontPageSettings == other.frontPageSettings &&
          ctDoujinshi == other.ctDoujinshi &&
          ctManga == other.ctManga &&
          ctArtistcg == other.ctArtistcg &&
          ctGamecg == other.ctGamecg &&
          ctWestern == other.ctWestern &&
          ctNonH == other.ctNonH &&
          ctImageset == other.ctImageset &&
          ctCosplay == other.ctCosplay &&
          ctAsianporn == other.ctAsianporn &&
          ctMisc == other.ctMisc &&
          favorites == other.favorites &&
          sortOrderFavorites == other.sortOrderFavorites &&
          ratings == other.ratings &&
          xn == other.xn &&
          xl == other.xl &&
          tagFilteringThreshold == other.tagFilteringThreshold &&
          tagWatchingThreshold == other.tagWatchingThreshold &&
          excludedUploaders == other.excludedUploaders &&
          xuQuotaUsing == other.xuQuotaUsing &&
          xuQuotaMax == other.xuQuotaMax &&
          searchResultCount == other.searchResultCount &&
          mouseOverThumbnails == other.mouseOverThumbnails &&
          thumbnailSize == other.thumbnailSize &&
          thumbnailRows == other.thumbnailRows &&
          thumbnailScaling == other.thumbnailScaling &&
          viewportOverride == other.viewportOverride &&
          sortOrderComments == other.sortOrderComments &&
          showCommentVotes == other.showCommentVotes &&
          sortOrderTags == other.sortOrderTags &&
          showGalleryPageNumbers == other.showGalleryPageNumbers &&
          hentaiAtHomeLocalNetworkHost == other.hentaiAtHomeLocalNetworkHost &&
          originalImages == other.originalImages &&
          alwaysUseMpv == other.alwaysUseMpv &&
          mpvStyle == other.mpvStyle &&
          mpvThumbnailPane == other.mpvThumbnailPane;
  ...
  int get hashCode =>
      ...
      loadImageThroughHAtH.hashCode ^
      loadBrowsingCountry.hashCode ^
      imageSize.hashCode ^
      imageSizeHorizontal.hashCode ^
      imageSizeVertical.hashCode ^
      galleryNameDisplay.hashCode ^
      archiverSettings.hashCode ^
      frontPageSettings.hashCode ^
      ctDoujinshi.hashCode ^
      ctManga.hashCode ^
      ctArtistcg.hashCode ^
      ctGamecg.hashCode ^
      ctWestern.hashCode ^
      ...
      ctImageset.hashCode ^
      ctCosplay.hashCode ^
      ctAsianporn.hashCode ^
      ctMisc.hashCode ^
      favorites.hashCode ^
      sortOrderFavorites.hashCode ^
      ratings.hashCode ^
      xn.hashCode ^
      xl.hashCode ^
      tagFilteringThreshold.hashCode ^
      tagWatchingThreshold.hashCode ^
      excludedUploaders.hashCode ^
      xuQuotaUsing.hashCode ^
      xuQuotaMax.hashCode ^
      searchResultCount.hashCode ^
      mouseOverThumbnails.hashCode ^
      thumbnailSize.hashCode ^
      thumbnailRows.hashCode ^
      thumbnailScaling.hashCode ^
      viewportOverride.hashCode ^
      sortOrderComments.hashCode ^
      showCommentVotes.hashCode ^
      sortOrderTags.hashCode ^
      showGalleryPageNumbers.hashCode ^
      hentaiAtHomeLocalNetworkHost.hashCode ^
      originalImages.hashCode ^
      alwaysUseMpv.hashCode ^
      mpvStyle.hashCode ^
