...
class GalleryProvider {
  ...
  factory GalleryProvider.fromJson(Map<String, dynamic> json) => GalleryProvider(
      ...
      parentHref:
          json['parentHref'] != null ? json['parentHref'] as String : null,
      ...
      lastViewTime:
          json['lastViewTime'] != null ? json['lastViewTime'] as int : null,
  ...
  GalleryProvider copyWith(
      ...
      GalleryProvider(
        ...
        parentHref: parentHref ?? this.parentHref,
  ...
  bool operator ==(Object other) =>
      ...
      other is GalleryProvider &&
          ...
          lastViewTime == other.lastViewTime &&
          pageOfList == other.pageOfList &&
          favNote == other.favNote &&
