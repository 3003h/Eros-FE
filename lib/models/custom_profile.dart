...
class CustomProfile {
  ...
  factory CustomProfile.fromJson(Map<String, dynamic> json) => CustomProfile(
      ...
      searchText: json['searchText'] != null
          ? (json['searchText'] as List? ?? [])
              .map((e) => e as dynamic)
              .toList()
          : null,
      listTypeValue: json['listTypeValue'] != null
          ? json['listTypeValue'] as String
          : null,
      catsTypeValue: json['catsTypeValue'] != null
          ? json['catsTypeValue'] as String
          : null,
      cats: json['cats'] != null ? json['cats'] as int : null,
      enableAdvance:
          json['enableAdvance'] != null ? json['enableAdvance'] as bool : null,
      advSearchTypeValue: json['advSearchTypeValue'] != null
          ? json['advSearchTypeValue'] as String
          : null,
      advSearch: json['advSearch'] != null
          ? AdvanceSearch.fromJson(json['advSearch'] as Map<String, dynamic>)
          : null,
      listModeValue: json['listModeValue'] != null
          ? json['listModeValue'] as String
          : null,
      hideTab: json['hideTab'] != null ? json['hideTab'] as bool : null,
      aggregateGroups: json['aggregateGroups'] != null
          ? (json['aggregateGroups'] as List? ?? [])
              .map((e) => e as String)
              .toList()
          : null);
  ...
  bool operator ==(Object other) =>
      ...
      other is CustomProfile &&
          ...
          catsTypeValue == other.catsTypeValue &&
          cats == other.cats &&
          enableAdvance == other.enableAdvance &&
          advSearchTypeValue == other.advSearchTypeValue &&
          advSearch == other.advSearch &&
          listModeValue == other.listModeValue &&
          hideTab == other.hideTab &&
          aggregateGroups == other.aggregateGroups;
  ...
  int get hashCode =>
      ...
      name.hashCode ^
      searchText.hashCode ^
      listTypeValue.hashCode ^
      catsTypeValue.hashCode ^
      cats.hashCode ^
      enableAdvance.hashCode ^
      advSearchTypeValue.hashCode ^
      advSearch.hashCode ^
      listModeValue.hashCode ^
      hideTab.hashCode ^
      aggregateGroups.hashCode;
}
