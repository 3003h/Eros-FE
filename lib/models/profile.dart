...
class Profile {
  ...
  factory Profile.fromJson(Map<String,dynamic> json) => Profile(
    ...
    advanceSearch: AdvanceSearch.fromJson(json['advance_search'] as Map<String, dynamic>),
    dnsConfig: DnsConfig.fromJson(json['dns_config'] as Map<String, dynamic>),
    downloadConfig: DownloadConfig.fromJson(json['download_config'] as Map<String, dynamic>),
  ...
  @override
  int get hashCode => ehConfig.hashCode ^ user.hashCode ^ lastLogin.hashCode ^ locale.hashCode ^ theme.hashCode ^ searchText.hashCode ^ localFav.hashCode ^ enableAdvanceSearch.hashCode ^ advanceSearch.hashCode ^ dnsConfig.hashCode ^ downloadConfig.hashCode ^ autoLock.hashCode;
}
