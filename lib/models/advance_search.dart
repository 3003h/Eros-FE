...
class AdvanceSearch {
  ...
  AdvanceSearch copyWith(
      ...
      AdvanceSearch(
        ...
        searchToreenFilenames:
            searchToreenFilenames ?? this.searchToreenFilenames,
        onlyShowWhithTorrents:
            onlyShowWhithTorrents ?? this.onlyShowWhithTorrents,
  ...
  bool operator ==(Object other) =>
      ...
      other is AdvanceSearch &&
          searchGalleryName == other.searchGalleryName &&
          searchGalleryTags == other.searchGalleryTags &&
          searchGalleryDesc == other.searchGalleryDesc &&
          searchToreenFilenames == other.searchToreenFilenames &&
          onlyShowWhithTorrents == other.onlyShowWhithTorrents &&
          searchLowPowerTags == other.searchLowPowerTags &&
          searchDownvotedTags == other.searchDownvotedTags &&
          searchExpunged == other.searchExpunged &&
          searchWithminRating == other.searchWithminRating &&
          minRating == other.minRating &&
          searchBetweenpage == other.searchBetweenpage &&
          startPage == other.startPage &&
          endPage == other.endPage &&
          disableDFLanguage == other.disableDFLanguage &&
          disableDFUploader == other.disableDFUploader &&
          disableDFTags == other.disableDFTags &&
          favSearchName == other.favSearchName &&
          favSearchTags == other.favSearchTags &&
          favSearchNote == other.favSearchNote;

  @override
  int get hashCode =>
      searchGalleryName.hashCode ^
      searchGalleryTags.hashCode ^
      searchGalleryDesc.hashCode ^
      searchToreenFilenames.hashCode ^
      onlyShowWhithTorrents.hashCode ^
      searchLowPowerTags.hashCode ^
      searchDownvotedTags.hashCode ^
      searchExpunged.hashCode ^
      searchWithminRating.hashCode ^
      minRating.hashCode ^
      searchBetweenpage.hashCode ^
      startPage.hashCode ^
      endPage.hashCode ^
      disableDFLanguage.hashCode ^
      disableDFUploader.hashCode ^
      disableDFTags.hashCode ^
      favSearchName.hashCode ^
      favSearchTags.hashCode ^
      favSearchNote.hashCode;
}
