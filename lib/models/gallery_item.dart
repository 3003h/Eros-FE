...
class GalleryItem {
  ...
  factory GalleryItem.fromJson(Map<String,dynamic> json) => GalleryItem(
    ...
    galleryPreview: json['galleryPreview'] != null ? (json['galleryPreview'] as List? ?? []).map((e) => GalleryPreview.fromJson(e as Map<String, dynamic>)).toList() : null,
