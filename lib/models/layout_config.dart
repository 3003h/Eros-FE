...
class LayoutConfig {
  ...
  factory LayoutConfig.fromJson(Map<String, dynamic> json) => LayoutConfig(
      itemConfigs: json['item_configs'] != null
          ? (json['item_configs'] as List? ?? [])
  ...
  LayoutConfig clone() =>
      LayoutConfig(itemConfigs: itemConfigs?.map((e) => e.clone()).toList());

  LayoutConfig copyWith({List<ItemConfig>? itemConfigs}) => LayoutConfig(
